<!-- Aquí va a preguntar si realmete desea eliminar el articulo -->
...
role="dialog" tabindex="-1" id="modal-delete-{{$art->idarticulo}}">
	<!-- Hacemos referencia al método destroy en el controlador y le enviamos el parámetro idarticulo -->
