...
@section ('contenido')
	<div class="row">
		<div class="col-lg-12 col-md-6 col-sm-6 col-xs-2">
			<h3>Editar Cliente: {{ $persona->nombre}}</h3> <!-- En el método editar tenemos la variable articulo -->
	...
	<div class="row">
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">			
			<div class="form-group">
				...
				<!-- El "nombre" va a ser recibido por PersonaFormRequest y también será usado por ClienteController en el método store-->
