<!-- Aquí va a preguntar si realmete desea cancelar la venta-->
...
role="dialog" tabindex="-1" id="modal-delete-{{$ven->idventas}}">
	<!-- Hacemos referencia al método destroy en el controlador y le enviamos el parámetro idventa -->
	<!-- Y el método para que llame al método destroy es "delete" -->
	{{Form::Open(array('action'=>array('VentaController@destroy',$ven->idventas),'method'=>'delete'))}}
