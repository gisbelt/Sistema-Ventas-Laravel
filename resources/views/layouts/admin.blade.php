...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Gisbel Torres</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <!-- Para cerrar la sesión. Que retorne a la vista logout -->
              ...
              <div class="box">
                ...
                <div class="box-body">
                  	<div class="row">
	                  	<div class="col-md-12">
		                    <!--Contenido-->
		                    <!-- Cuando haga referencia a esta plantilla blade pueda agregarle 
		                    una sección llamada contenido -->
                            @yield('contenido')  	
		                    <!--Fin Contenido-->
                           </div>
                        </div>
    ...
    <!-- En cualquier plantilla que yo haga referencia a "scripts" osea: @push ('scripts'), es como si estuviera escribiendolo aquí -->
    @stack('scripts') <!-- Si yo  estoy extendiendo esta plantilla admin.blade desde otra plantilla, cuando haga uso de ese "scripts" voy a poder aquí utilizar script -->
    <!-- Bootstrap 3.3.5 -->
