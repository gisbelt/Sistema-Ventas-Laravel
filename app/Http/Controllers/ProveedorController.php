...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request)
    {
    	...
    	if($request)
    	{
    		...
    		//para poder filtrar todas las personas (proveedores)
    		...
    		->where('tipo_persona','=','Proveedor') //Donde el tipo_persona sea igual a Proveedor 
    		->orwhere('num_documento','LIKE','%'.$query.'%') //o busca por num_documento donde la persona sea un Proveedor
    		->where('tipo_persona','=','Proveedor') 
    		->orderBy('idpersona','desc')
    		->paginate(7) //De cuantos registros vamos a realizar la paginación
    		; //Punto y coma al final
    		//Van a ver tres vistas, una carpeta llamada compras, proveedor y dentro de proveedor una llamada index
...
/*******************************************************************************************************************************************************************************************************************************/
    ...
    public function store(PersonaFormRequest $request)
    {
    	...
    	return Redirect::to('compras/proveedor'); //Redirecionamos a la URL compras/proveedor (vista)
    }
...
/*******************************************************************************************************************************************************************************************************************************/
    ...
    {
    	//La persona (proveedor) que voy a mostrar sera igual a mi modelo Persona
    	//Llamame a esta vista pero enviale esta persona (proveedor) (id) para que la muestre
    	return view("compras.proveedor.show",["persona"=>Persona::findOrFail($id)]);
    }

/*******************************************************************************************************************************************************************************************************************************/

    //Los mismo de arriba, vamos a modificar los datos de una persona (proveedor) específica
...
/*******************************************************************************************************************************************************************************************************************************/
    ...
    public function update(PersonaFormRequest $request, $id) //Este id se compara con el id del Modelo
    {
    	...
    	//No modificamos tipo_persona porque siempre será de tipo proveedor
    	$persona->nombre=$request->get('nombre'); //El objeto de validacion se llama nombre
    	$persona->tipo_documento=$request->get('tipo_documento');
    	$persona->num_documento=$request->get('num_documento');
    	$persona->direccion=$request->get('direccion');
